...
public class PaymentService {
    ...
    public static void setBoxOn(Box box) throws SQLException {
        paymentModel.setTookBoxIsReadyTrue(box);
    }

    public static void setBoxOff(Box box) throws SQLException {
        paymentModel.setTookBoxIsReadyFalse(box);
    }
}
